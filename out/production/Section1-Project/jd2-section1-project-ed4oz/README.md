...
## Bir movie kütüphanesi projesi yazınız. 

1. **Movie sınıfı**: Her bir movie için bir Movie sınıfı oluşturun. Bu sınıf, filmin id'sini, filmin başlığını, yönetmenini, oyuncularını, tarihini, açıklamasını, türünü  içermelidir.
...
3. **Movie yöneticisi**:  Movie sınıfını kullanarak movie eklemek, movie silmek, movie aramak vb. işlemler yapabilecek bir Movie Yöneticisi sınıfı oluşturun.
...
5. **Ana menü**: Kullanıcıların filmleri arayabilecekleri, filmleri listelebilecekleri ve kullanıcı hesaplarını yönetebilecekleri bir ana menü oluşturun. Bu menü, kullanıcı girişi ve çıkışı, movie ekleme, movie silme, movie arama, kullanıcı hesapları oluşturma, kullanıcı hesaplarını silme, kullanıcı hesapları arama işlemlerini içermelidir.
